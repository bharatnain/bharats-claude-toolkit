...
- Take your winning ad
- Feed to Claude/ChatGPT with the prompt:
...
|----------|----------|:---:|-------|
| **Google Ads** | Search intent, high-intent traffic | ✓ | google-ads |
| **Meta Ads** | Demand gen, visual products, B2C | - | meta-ads |
| **LinkedIn Ads** | B2B, job title targeting | - | linkedin-ads |
| **TikTok Ads** | Younger demographics, video | - | tiktok-ads |

For tracking setup, see [references/conversion-tracking.md](references/conversion-tracking.md), ga4, segment
