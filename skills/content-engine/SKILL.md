...
If the user wants a specific person's voice, still treat `brand-voice` as the source of truth and feed it the best live or source-derived material available.
...
- cross-platform distribution tooling for platform-specific publishing
- a social API for sourcing recent posts and publishing approved output, if available
