...
> **Freshness note (2026-09-22):** vendored from the `claude-api` skill bundled with Claude Code 2.1.280. Cache-read pricing: $0.25/MTok on Claude Fable 5.1, $0.20/MTok on Claude Opus 5.5 (GA 2026-09-22); minimum cacheable prefix 512 tokens on Opus 5.5 / Opus 5 / Fable 5.1.
