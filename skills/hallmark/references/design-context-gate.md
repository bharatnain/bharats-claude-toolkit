# Design flow · Step 1 — Design-context gate

Moved verbatim from `SKILL.md` § Design flow. Covers the three-question gate, genre detection, the catalog/custom theme-route signals, and the opt-out inference protocol.
