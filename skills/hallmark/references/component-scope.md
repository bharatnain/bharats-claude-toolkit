...
Moved verbatim from `SKILL.md` § When the brief is a component, not a page. Run this instead of the page-level Design flow when the brief is a single UI element.
