...
For a shareable standalone HTML version of this report, the JSON→HTML generator pattern in the ad-creative skill's creative-review-page reference is the model (escape every value; keep it self-contained).
