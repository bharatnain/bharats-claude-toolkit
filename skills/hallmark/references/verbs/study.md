# `hallmark study` — verb procedure

Moved verbatim from `SKILL.md` § `hallmark study`. The extraction protocol, schemas, templates, and refusal heuristics live in [study.md](../study.md); read both before the verb runs.
