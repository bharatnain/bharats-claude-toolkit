...
4. If you have access to the author's live social feed or post archive, pull recent original posts before drafting.
...
## Fallback Defaults (when source material is thin)

If real source material is thin and the user has no specific voice in mind, start from these neutral strong-writing defaults unless newer source material overrides them:
