...
|------|----------|:---:|-------|
| **Customer.io** | Behavior-based automation | - | customer-io |
| **Mailchimp** | SMB email marketing | ✓ | mailchimp |
| **Nitrosend** | AI-native email (sequences via prompts) | ✓ | nitrosend |
| **Resend** | Developer-friendly transactional | ✓ | resend |
| **SendGrid** | Transactional email at scale | - | sendgrid |
| **Kit** | Creator/newsletter focused | - | kit |
