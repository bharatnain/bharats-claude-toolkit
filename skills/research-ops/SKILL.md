...
This is an orchestration wrapper around a research stack. It is not a replacement for `deep-research` or dedicated web-search / market-research skills; it tells you when and how to use them together.

## Skill Stack

Pull these complementary capabilities into the workflow when available:

- fast current-web discovery (web search / `WebSearch`)
...
- lead/company intelligence when the task is people/company targeting instead of generic research
- durable knowledge capture when the result should be stored in persistent context afterward
